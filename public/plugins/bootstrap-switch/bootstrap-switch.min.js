        ...
        h = function() {
            ...
            return f(j, [{
                ...
                value: function() {
                    ...
                    if (!l.options.state)
                        width = l.$wrapper.hasClass('bootstrap-switch-id-statusRequest') ? 19 : (l.$wrapper.hasClass('bootstrap-switch-id-featuredCat') || l.$wrapper.hasClass('bootstrap-switch-id-topOffer') || l.$wrapper.hasClass('bootstrap-switch-id-manageStock') || l.$wrapper.hasClass('bootstrap-switch-id-quickGrab') || l.$wrapper.hasClass('bootstrap-switch-id-exclusive') || l.$wrapper.hasClass('bootstrap-switch-id-statusOrder') ? 0 : 10)
                    return m.width(n), this.$label.width(function(o, p) {
                        return 'auto' === l.options.labelWidth ? p < n ? n : p : l.options.labelWidth
                    }), this._handleWidth = this.$on.outerWidth(), this._labelWidth = this.$label.outerWidth(), this.$container.width(2 * this._handleWidth + this._labelWidth), this.$wrapper.width(this._handleWidth + this._labelWidth + width)
                }
            }, {
                ...
                value: function() {
                    ...
                    return this.$on.on('click.bootstrapSwitch', function(m) {
                        var width = l.$wrapper.hasClass('bootstrap-switch-id-statusRequest') ? Number(l.$wrapper.css('width').split('px')[0]) + 19 : (l.$wrapper.hasClass('bootstrap-switch-id-featuredCat') || l.$wrapper.hasClass('bootstrap-switch-id-topOffer') || l.$wrapper.hasClass('bootstrap-switch-id-manageStock') || l.$wrapper.hasClass('bootstrap-switch-id-quickGrab') || l.$wrapper.hasClass('bootstrap-switch-id-exclusive') ? Number(l.$wrapper.css('width').split('px')[0]) : (l.$wrapper.hasClass('bootstrap-switch-id-statusOrder') ? Number(l.$wrapper.css('width').split('px')[0]) : Number(l.$wrapper.css('width').split('px')[0]) + 10));
                        l.$wrapper.css('width', width);
