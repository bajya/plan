                        ...
                        <form class="form-material m-t-50 row form-valide" method="post" action="{{$url}}" enctype="multipart/form-data">
                            ...
                            <div class="sampleSheet col-12">
                                <div class="dt-buttons">
                                    <a href="{{ asset('public/download/Sample_Doctor_File.csv') }}" class="btn dt-button py-2" download>Download Sample File</a>
                                </div>
                                <div class="variantRow">
                                    ...
                                    <p>
                                        <ol>
                                            ...
                                            <li>Do not leave any blank row between two new Doctors.</li>
                                        </ol>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 p-0">
                                <div class="form-group col-md-6 m-t-20 float-left">
                                    ...
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        ...
                                        <input type="file" required name="doctor_import" accept=".csv,.zip"> </span> <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                                    </div>
                                </div>
                            </div>
