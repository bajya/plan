                            ...
                            <!-- <div class="col-md-12 p-0"> -->
                                        ...
                                        @if(count($brands) > 0)
                                            ...
                                            @if($brands)
                                                @foreach($brands as $id=> $des)
                                                    <option value="{{$des->id}}" @if($strain->brand_id==$des->id) selected @endif>{{ ucfirst($des->name) }}</option>
                                                @endforeach
                                            @endif
                                        @else
                                ...
                                <div class="form-group col-md-6 m-t-20"  style="display: none;">
                                    ...
                                    <select class="form-control" name="dispensary_id" id="dispensary_id">
                                        ...
                                        @if(!empty($dispensarys))
                                            @if($dispensarys)
                                                @foreach($dispensarys as $id=> $des)
                                                    <option value="{{$des->id}}" @if($strain->dispensary_id==$des->id) selected @endif>{{ ucfirst($des->name) }}</option>
                                                @endforeach
                                            @endif
                                        @else
                                ...
                                <div class="form-group col-md-6 m-t-20">
                                    ...
                                    <input type="text" class="form-control form-control-line" name="strain_name" value="{{old('name', $strain->name)}}" maxlength="100">
                                </div>
                            <!-- </div> -->
                            
                            <div class="form-group col-md-12 m-t-20" style="display: none;">
                                <label>Description</label><sup class="text-reddit"> *</sup>
                                <textarea class="form-control form-control-line" name="description" rows="5">Test Description</textarea>
                            </div>
